...
const themes = {
    ...
    default: {
        primary: {
            ...customPalettes.srfGrey,
            DEFAULT: customPalettes.srfGrey['700'],
        },
        accent: {
            ...customPalettes.srfRed,
            DEFAULT: customPalettes.srfRed['700'],
        },
        warn: {
            ...colors.red,
...
const config = {
    ...
    theme: {
        ...
        extend: {
            ...
            colors: {
                gray: colors.slate,
                indigo: customPalettes.srfRed,
                srfRed: customPalettes.srfRed,
                srfGrey: customPalettes.srfGrey,
            },
            flex: {
                0: '0 0 auto',
            },
